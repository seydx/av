                    ...
                    "OS=='win'",
                    {
                        ...
                        "conditions": [
                            ...
                            [
                                ...
                                {
                                    "variables": {
                                        "ffbuild_prefix%": "/clang64/ffbuild",
                                        "conditions": [
                                            [
                                                "target_arch=='arm64'",
                                                {
                                                    "ffbuild_prefix%": "/clangarm64/ffbuild"
                                                },
                                            ]
                                        ],
                                    },
                                    "include_dirs": ["<(ffbuild_prefix)/include"],
                                    "library_dirs": ["<(ffbuild_prefix)/lib"],
                                    "libraries": [
                                        ["target_arch=='x64'", "-l:libvpl.a"],
                                        # FFmpeg
                                        "-Wl,-Bstatic",
                                        "-Wl,--whole-archive",
                                        "libavformat.a",
